        ...
        <section id="about" className="text-center">
            ...
            <div className="flex flex-col xl:flex-row justify-center md:justify-between gap-12 mt-24">
                <div className="basis-1/2">
                    <div className="bg-gradient-to-br from-bermuda via-metal/40 to-bermuda w-60 h-60 lg:w-96 lg:h-96 rounded-3xl mx-auto">
                        <img className="my-img" src={Me} alt="Amin" />
                    </div>
                </div>
