      ...
      <div className="about">
        <div className="basis-1/2">
          <div className="bg-img">
            <img className="about-img hover:bg-shadow" src={Me} alt="Amin" />
          </div>
        </div>
        <div className="basis-1/2 px-12 mx-auto">
          ...
          <p className="py-8 text-lg text-silver select-none">
            Hello there!I 'm a MERN Stack Developer, and I' m very passionate
            and dedicated to my work.With 2 years of experience as a
            professional Web Developer, I have the skills and knowledge
            necessary to make your business successful.I enjoy every step of
